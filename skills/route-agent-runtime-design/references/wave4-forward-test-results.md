...
| --- | ---: | ---: | ---: | ---: | --- |
| `design-agent-retrieval` | 3 | 3 | 0 | 0 | pass |
| `design-proactive-agents` | 3 | 2 | 1 | 0 | pass with minor follow-up |
| `reduce-agent-friction` | 3 | 3 | 0 | 0 | pass |
...
1. `design-proactive-agents/SKILL.md`

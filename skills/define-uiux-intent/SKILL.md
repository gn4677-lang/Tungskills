...
Use this as a design-intent protocol. Define audience, purpose, interaction model, visual direction, and anti-slop constraints before implementation.
...
- If "interface" means module/API/type/method shape rather than user-facing UI or interaction, route to `check-architecture-boundaries`.
...
When the task asks for design generation rather than only intent review, include:

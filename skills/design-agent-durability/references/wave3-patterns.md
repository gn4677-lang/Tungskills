...
- Route to `design-agent-context` when the question is what belongs in context now.
- Route to `design-agent-fallbacks` when the question is user-visible degraded behavior after provider/tool failure.

---
name: design-proactive-agents
description: "Use when designing or reviewing proactive agent behavior: reminders, scheduled work, wake triggers, event triggers, thresholds, external signals, autonomy tiers, approval/dismiss/undo surfaces, false-positive silence, or 主動提醒. Trigger on cron, wake, proactive, follow-up, nudge, background notification, or whether the agent should stay silent."
---
...
Use this as a proactive-behavior design protocol. Start from the wake condition and interruption risk, then return autonomy, approval, dismissal, and silence conditions.
...
- If the core complaint is outage handling or degraded response behavior, route to `design-agent-fallbacks`.

...
Read `anti-slop-direction-examples.md` when you need concrete bad-vs-better contrast before choosing a layout direction. If the distinction is still too abstract, read `../../uiux-objective-review/references/visual-example-index.md` and inspect the paired SVG gallery.
